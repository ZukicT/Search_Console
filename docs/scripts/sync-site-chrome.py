...
def blog_promo_banner_block(prefix: str) -> str:
    ...
    <div class="container">
      <div class="blog-app-promo-banner__inner">
        ...
        <a href="{APP_STORE}" class="blog-app-promo-banner__cta" target="_blank" rel="noopener" data-i18n-aria-label="nav.download">
          <svg class="blog-app-promo-banner__cta-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
            <path d="M12 3v12"/>
            <path d="m7 10 5 5 5-5"/>
            <path d="M5 21h14"/>
          </svg>
          <span class="blog-app-promo-banner__cta-label" data-i18n="nav.download">Download</span>
        </a>
      </div>
    </div>
  </aside>"""
